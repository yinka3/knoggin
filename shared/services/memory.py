"""Unified memory manager — session blocks + working memory.

Lives in shared/ so both agent/ and sdk/ can import it.
Single implementation used by KnogginAgent, Tools, and any SDK consumer.
"""
