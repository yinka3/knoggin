...
from api.commands.registry import CommandContext, execute, get_suggestions
...
async def execute_command(
    body: ExecuteRequest, state: AppState = Depends(get_app_state)
):
...
async def autocomplete(q: str = "", state: AppState = Depends(get_app_state)):
