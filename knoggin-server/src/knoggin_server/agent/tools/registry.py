...
def _maintenance_candidate_for_tool(ctx, tool_name: str):
    from knoggin_server.agent.maintenance import find_candidate_for_tool
...
async def _mark_maintenance_handled(ctx, tools, candidate) -> None:
    ...
    from knoggin_server.agent.maintenance import mark_maintenance_handled
...
async def _record_maintenance_failure(ctx, tools, candidate) -> None:
    ...
    from knoggin_server.agent.maintenance import record_maintenance_failure
