"""Tests for jobs/jobs_utils.py — parsers, formatters, and helpers. Pure logic, no async."""
...
class TestProcessExtractedFacts:
    ...
    def test_already_invalidated_facts_ignored(self):
    ...
    def test_mixed_operations(self):
        ...
        result = process_extracted_facts(existing, new)
        assert "f1" in result.to_invalidate
        assert "f2" in result.to_invalidate
        assert len(result.new_contents) == 2
