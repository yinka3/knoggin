...
from knoggin_server.knowledge.services import fact_change_service as service_module
from knoggin_server.knowledge.services.fact_change_service import FactChangeService
