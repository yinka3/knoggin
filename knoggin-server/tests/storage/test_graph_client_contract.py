...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("create_preference", "graph_writer", ("id1", "content", "kind", "session"), {}),
        ...
        ("update_entity_profile", "entity_writer", (1, "name", [0.1], 123), {"project_id": "test"}),
        ("update_entity_canonical_name", "entity_writer", (1, "name"), {"project_id": "test"}),
        ("update_entity_embedding", "entity_writer", (1, [0.1]), {"project_id": "test"}),
        ("update_entity_checkpoint", "entity_writer", (1, 123), {"project_id": "test"}),
        ("update_entity_aliases", "entity_writer", ({1: ["a"]},), {"project_id": "test"}),
        ...
        # --- Fact Writer (3) ---
        ("create_facts_batch", "fact_writer", (1, ["fact"]), {"user_name": "ada", "session_id": "session-1", "project_id": "test"}),
        ("invalidate_fact", "fact_writer", ("fid", "2025-01-01"), {"project_id": "test"}),
        ("delete_old_invalidated_facts", "fact_writer", ("2025-01-01",), {"project_id": "test"}),
        ...
        ("search_entities_by_embedding", "entity_reader", ([0.1], 10, 0.8, ["test"]), {}),
        ...
        ("get_facts_from_message", "fact_reader", (1,), {"user_name": "ada", "session_id": "session-1"}),
        ...
        ("get_hierarchy_candidates", "graph_reader", ("topic", "parent", ["child"], 2), {}),
        ...
        # --- Tool Queries (6) ---
        ("get_hot_topic_context_with_messages", "tools", (["hot"], 5, False, ["test"]), {}),
...
async def test_graph_client_facade_delegates_correctly(
    ...
    # Verify the RecordingComponent intercepted the correct arguments and returned the mocked result
