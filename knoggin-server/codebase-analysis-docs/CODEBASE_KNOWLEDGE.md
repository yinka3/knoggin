...
- `src/knoggin_server/session/`: active session context, message intake, and
  session bootstrapping.
- `src/knoggin_server/project/`: durable project loading and project-scoped
  runtime state.
- `src/knoggin_server/ingestion/`: async message processing and extraction.
- `src/knoggin_server/knowledge/`: SQL/AGE graph writes, retrieval helpers,
  documents, fact resolution, and entity merge policy.
- `src/knoggin_server/agent/`: agent orchestration, prompt assembly, tool
  execution, and durable agent management.
- `src/knoggin_server/community/`: multi-agent community discussions.
...
- `src/knoggin_server/knowledge/db/tool_queries.py`
...
- `src/knoggin_server/ingestion/services/processor.py`
- `src/knoggin_server/ingestion/jobs/profile_job.py`
- `src/knoggin_server/knowledge/services/fact_resolution.py`
