...
```text
src/knoggin_server/knowledge/services/documents/
  __init__.py
  service.py
  scan.py
  storage.py
...
```text
src/knoggin_server/knowledge/db/readers/document_reader.py
src/knoggin_server/knowledge/db/writers/document_writer.py
```
...
`src/knoggin_server/knowledge/services/document_service.py` module does not
