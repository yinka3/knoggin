...
**File:** `knoggin-server/src/knoggin_server/agent/types.py`
...
**File:** `knoggin-server/src/knoggin_server/knowledge/services/entity_service.py`
...
**Files:** `knoggin-server/src/knoggin_server/agent/types.py`, `knoggin-server/src/knoggin_server/community/community_manager.py`
...
**File:** `knoggin-server/src/knoggin_server/session/session_manager.py`
...
**File:** `knoggin-server/src/knoggin_server/project/project_manager.py`
...
**File:** `knoggin-server/src/knoggin_server/ingestion/services/processor.py`
