...
def patch_profile_events(monkeypatch):
    ...
    monkeypatch.setattr("core.ingestion.jobs.profile_job.emit", fake_emit)
    return events
...
async def test_process_single_batch_applies_facts_without_redirtying(
    ...
    monkeypatch.setattr(
        "core.ingestion.jobs.profile_job."
...
async def test_refine_user_profile_applies_global_scope_without_redirtying_user(
    ...
    monkeypatch.setattr(
        "core.ingestion.jobs.profile_job.enrich_facts_with_sources",
