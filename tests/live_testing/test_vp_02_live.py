...
Tests that the LLM correctly identifies relationships between entities
based on explicit interactions, shared events, and stated relationships.
Co-mention alone should NOT create connections.

Run with: uv run pytest test_connections_live.py -v -s
...
from main.prompts import get_connection_reasoning_prompt
...
# ══════════════════════════════════════════════════════════════════════
#  BASELINE FIXTURES — Clear-cut cases
# ══════════════════════════════════════════════════════════════════════
...
# ══════════════════════════════════════════════════════════════════════
#  STRESS FIXTURES — Long, messy, realistic conversations
# ══════════════════════════════════════════════════════════════════════
